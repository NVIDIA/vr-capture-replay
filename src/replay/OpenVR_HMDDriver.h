...
class OpenVR_HMDDriver : public vr::ITrackedDeviceServerDriver, public vr::IVRDriverDirectModeComponent, public vr::IVRDisplayComponent
{
public:
    enum VSyncStyle
    {
...
public:
    ...
    float GetDisplayFrequency() const { return m_flDisplayFrequency; }
