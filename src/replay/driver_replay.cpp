...
public:
    ...
    virtual bool ShouldBlockStandbyMode() override { return true; } // according to OpenVR dev, this is not called anymore
...
VRData::TrackingItem OpenVR_ServerDriver::Interpolate(VRData::TrackingItem ti0, VRData::TrackingItem ti1, double alpha)
{
    ...
    auto quat_dot = [](double q0[4], double q1[4])
    {
